...
<head>
    ...
    <style>
        body {
            ...
            /* Évite la répétition */
            height: 100vh;
            /* Assure que le fond couvre toute la hauteur de l'écran */
            margin: 0;
                    ...
                    <div class="modal-content rounded-4 shadow">
                        ...
                        <div class="modal-body p-5 pt-0">
                            <form class="" action="traitement.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="date_debut" class="form-control rounded-3"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="organisateur" class="form-control rounded-3"
                                        id="floatingInput" placeholder="name@example.com">
                                ...
                                <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit"
                                    name="submit">Ajouter Événement</button>
                            </form>
                        </div>
                    </div>
                </div>
